...
class Vgg16BN():
    ...
    def __init__(self, size=(224,224), include_top=True, local_file_path = None):
    ...
    def get_classes(self):
        ...
        fpath = get_file(fname, self.FILE_PATH+fname, cache_subdir='models') if not self.local_file_path else self.local_file_path+fname
